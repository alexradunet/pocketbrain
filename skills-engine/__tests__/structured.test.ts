...
describe('structured', () => {
  ...
  describe('mergeBunDependencies', () => {
    it('adds new dependencies', () => {
      ...
      mergeBunDependencies(pkgPath, { newdep: '^2.0.0' });
    ...
    it('resolves compatible ^ ranges', () => {
      ...
      mergeBunDependencies(pkgPath, { dep: '^1.1.0' });
    ...
    it('sorts devDependencies after merge', () => {
      ...
      mergeBunDependencies(pkgPath, { middle: '^1.0.0' });
    ...
    it('throws on incompatible major versions', () => {
      ...
      expect(() => mergeBunDependencies(pkgPath, { dep: '^2.0.0' })).toThrow();
    });
  });
