...
PocketBrain gives you the core functionality without that mess.
...
I don't need an installation wizard - OpenCode CLI guides the setup. I don't need a monitoring dashboard - I ask OpenCode CLI what's happening. I don't need elaborate logging UIs - I ask OpenCode to read the logs. I don't need debugging tools - I describe the problem and OpenCode fixes it.
...
A personal OpenCode assistant accessible via WhatsApp, with minimal custom code.

**Core components:**
- **OpenCode SDK** as the core agent harness
...
- Setup and customization done via OpenCode CLI
- Users clone the repo and run OpenCode CLI to configure
...
**PocketBrain** - A reference to Clawdbot (now OpenClaw).
