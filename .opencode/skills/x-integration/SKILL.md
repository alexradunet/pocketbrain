...
bunx dotenv -e .env -- bun .opencode/skills/x-integration/scripts/setup.ts
...
â”‚  Container (Linux VM)                                       â”‚
â”‚  â””â”€â”€ agent.ts â†’ MCP tool definitions (x_post, etc.)    â”‚
â”‚      â””â”€â”€ Writes IPC request to /workspace/ipc/tasks/       â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                       â”‚ IPC (file system)
                       â–¼
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚  Host (macOS)                                               â”‚
â”‚  â””â”€â”€ src/ipc.ts â†’ processTaskIpc()                         â”‚
â”‚      â””â”€â”€ host.ts â†’ handleXIpc()                         â”‚
â”‚          â””â”€â”€ spawn subprocess â†’ scripts/*.ts               â”‚
â”‚              â””â”€â”€ Playwright â†’ Chrome â†’ X Website           â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
â”œâ”€â”€ host.ts           # Host-side IPC handler
â”œâ”€â”€ agent.ts          # Container-side MCP tool definitions
â”œâ”€â”€ lib/
â”‚   â”œâ”€â”€ config.ts     # Centralized configuration
â”‚   â””â”€â”€ browser.ts    # Playwright utilities
â””â”€â”€ scripts/
    â”œâ”€â”€ setup.ts      # Interactive login
    â”œâ”€â”€ post.ts       # Post tweet
    â”œâ”€â”€ like.ts       # Like tweet
    â”œâ”€â”€ reply.ts      # Reply to tweet
    â”œâ”€â”€ retweet.ts    # Retweet
    â””â”€â”€ quote.ts      # Quote tweet
```
...
```bash
echo '{"content":"Test tweet - please ignore"}' | bunx dotenv -e .env -- bun .opencode/skills/x-integration/scripts/post.ts
```

### Test Like

```bash
echo '{"tweetUrl":"https://x.com/user/status/123"}' | bunx dotenv -e .env -- bun .opencode/skills/x-integration/scripts/like.ts
```
...
echo '{"content":"Test"}' | bun .opencode/skills/x-integration/scripts/post.ts
```
