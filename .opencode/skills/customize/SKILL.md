...
Persona changes â†’ edit `groups/AGENTS.md`
Per-group behavior â†’ edit specific group's `AGENTS.md`
...
Implementation:
1. Commands are handled by the agent naturally â€” add instructions to `groups/AGENTS.md` or the group's `AGENTS.md`
