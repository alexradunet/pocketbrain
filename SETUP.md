...
This project requires Go 1.26+. Install the official binary distribution:
...
echo "aac1b08a0fb0c4e0a7c1555beb7b59180b05dfc5a3d62e40e9de90cd42f88235  /tmp/go${GO_VERSION}.linux-amd64.tar.gz" \
  | sha256sum -c
...
# Add to system PATH
echo 'export PATH="/usr/local/go/bin:/home/debian/go/bin:$PATH"' \
...
```bash
go version   # should print: go version go1.26.0 linux/amd64
```
...
All work lives in `~/pocketbrain-repo` and is tracked in git.
